...
template<typename BaselineNumber, typename LoadFileName1, typename LoadFileName2>
void execute(BaselineNumber& b, const LoadFileName1& lfn1, const LoadFileName2& lfn2) {
    Query q;
